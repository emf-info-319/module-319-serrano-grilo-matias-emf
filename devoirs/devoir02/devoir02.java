...
public class devoir02 {
    ...
    public static void main(String[] args) {
        int remplissage = (int) (Math.random() * (CAPACITE_RESERVOIR_A+CAPACITE_RESERVOIR_B - 0 + 1)) + 0;// nombre aléatoire entre 0  et 8
        ...
        while (CAPACITE_RESERVOIR_A + CAPACITE_RESERVOIR_B >= remplissage) {//tant que la capacité de a et b est plus grand que le remplisage faire ce qui est dedans
            ...
            if (reservoirA < CAPACITE_RESERVOIR_A) {//si le reservoir a est plus petit que troi faire ça
